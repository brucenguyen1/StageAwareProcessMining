...
public class SPFFlowEfficiencyView extends NodeView {
	public SPFFlowEfficiencyView(SPF bpf, SPFStage stage, String desc) {
	...
	public JFreeChart createChart(XYDataset xydataset) {
		JFreeChart jfreechart = ChartFactory.createTimeSeriesChart(getLabel() + " - " + getStageName(), "", "Percent",
