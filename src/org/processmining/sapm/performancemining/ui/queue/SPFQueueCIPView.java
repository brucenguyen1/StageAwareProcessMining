...
public class SPFQueueCIPView extends NodeView {
	public SPFQueueCIPView(SPF bpf, SPFStage stage, String desc) {
	...
	public JFreeChart createChart(XYDataset xydataset) {
		JFreeChart jfreechart = ChartFactory.createTimeSeriesChart(getLabel() + " - " + getStageName(), "", "Cases",
