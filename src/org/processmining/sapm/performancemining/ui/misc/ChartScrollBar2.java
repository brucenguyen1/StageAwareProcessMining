package org.processmining.sapm.performancemining.ui.misc;
...
public class ChartScrollBar2 extends JScrollBar implements AdjustmentListener, AxisChangeListener, MouseListener,
		DatasetChangeListener {
	/**
	 * 
	 */
	private static final long serialVersionUID = 2731412413745998801L;
	private final JFreeChart chart;
	private XYPlot plot;
	private double ratio;
	private boolean updating = false;

	public ChartScrollBar2(int orientation, JFreeChart chart) {
		this(orientation, chart, null);
	}

	public ChartScrollBar2(int orientation, JFreeChart chart, XYPlot plot) {
		super(orientation);
		this.chart = chart;
		if (plot == null) {
