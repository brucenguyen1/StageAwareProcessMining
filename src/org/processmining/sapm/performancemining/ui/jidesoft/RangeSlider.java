 ...
 */
package org.processmining.sapm.performancemining.ui.jidesoft;
...
/**
 * <tt>RangeSlider</tt> is a slider that can be used to select a range. A
 * regular slider has only one thumb. So it can only be used to select one
 * value. <tt>RangeSlider</tt> has two thumbs. Each one can be moved
 * independently or both are moved together.
 * <p/>
 * {@link #getLowValue()} will return the value of low range and
 * {@link #getHighValue()} is the high range.
 */
public class RangeSlider extends JSlider {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -8827037270502452798L;

	private static final String uiClassID = "org.processmining.stagedprocessflows.ui.jidesoft.WindowsRangeSliderUI";
	...
	/**
	 * Creates a horizontal range slider with the range 0 to 100 and initial low
	 * and high values both at 50.
	 */
	public RangeSlider() {
	}

	/**
	 * Creates a range slider using the specified orientation with the range 0
	 * to 100 and initial low and high values both at 50.
	 * 
	 * @param orientation
	 *            the orientation of the <code>RangeSlider</code>.
	 */
	 ...
	 * initial value equal to the average of the min plus max. and initial low
	 * and high values both at 50.
	 * 
	 * @param min
	 ...
	 *            the maximum value of the slider.
	 * @param low
	 *            the low value of the slider since it is a range.
	 * @param high
	 *            the high value of the slider since it is a range.
	 */
	...
	public void updateUI() {
		try {
			...
			Class<?> uiClass = Class.forName(getActualUIClassID());
	...
	/**
	 * Sets the range slider's low value. This method just forwards the value to
	 * the model.
	 * 
	 * @param lowValue
	 *            the new low value
	...
	/**
	 * Sets the range slider's high value. This method just forwards the value
	 * to the model.
	 * 
	 * @param highValue
	 *            the new high value
	...
	/**
	 * Checks if the range is draggable. If true, user can drag the area between
	 * the two thumbs to drag the range.
	 * 
	...
	/**
	 * Sets the flag if the range is draggable. If true, user can drag the area
	 * between the two thumbs to drag the range.
	 * 
