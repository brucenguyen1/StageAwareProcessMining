package org.processmining.sapm.performancemining.parameters;
...
public class SPFConfig {
	...
	private List<String> stageWithFakeEvents = new ArrayList<>(); 
	...
	private List<String> caseExitStatusList = new ArrayList<String>();
	...
	public List<String> getFakeStages() {
		return stageWithFakeEvents;
	}	
	...
	public List<String> getCaseExitStatusList() {
		return caseExitStatusList;
	}

	public void setCaseExitStatusList(List<String> newList) {
		caseExitStatusList = newList;
	}
