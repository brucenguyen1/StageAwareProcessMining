...
import org.processmining.sapm.stagemining.algorithm.DecompositionTree;
import org.processmining.sapm.stagemining.graph.Vertex2;
import org.processmining.sapm.stagemining.graph.WeightedDirectedEdge;
...
public class StageDecomposition {
	...
	private void mine(int minStageSize, AbstractStageMiningAlgo miningAlgo) throws Exception {
		...
		this.baseGraph = GraphUtils.buildProcessGraph(this.baseLog);
...
//	}
	...
	public double getGroundTruthIndex() throws Exception {
		double gtIndex = LogUtils.compareWithLogGroundTruth(this.getStageListModel().getActualStageLabels(), this.baseLog);
		return gtIndex;
	}
