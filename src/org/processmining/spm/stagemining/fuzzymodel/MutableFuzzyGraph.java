package org.processmining.spm.stagemining.fuzzymodel;
...
import org.processmining.spm.stagemining.fuzzymodel.impl.FMEdgeImpl;
import org.processmining.spm.stagemining.fuzzymodel.impl.StageFMEdgeImpl;
import org.processmining.spm.stagemining.fuzzymodel.metrics.MetricsRepository;
...
import org.processmining.spm.stagemining.fuzzymodel.transform.TransformerUtils;
import org.processmining.spm.stagemining.fuzzymodel.util.FMLogEvents;
import org.processmining.spm.stagemining.fuzzymodel.util.FuzzyMinerLog;
...
public class MutableFuzzyGraph extends AbstractDirectedGraph<FMNode, FMEdge<? extends FMNode, ? extends FMNode>>
	...
	public MutableFuzzyGraph(int numberOfInitialNodes) {
	...
	public synchronized FMEdgeImpl addStageEdge(FMNode source, FMNode target, double significance, double correlation) {
		checkAddEdge(source, target);
		FMEdgeImpl edge = new StageFMEdgeImpl(source, target, significance, correlation);
		if (fmEdges.add(edge)) {
			graphElementAdded(edge);
			return edge;
		} else {
