...
import org.processmining.spm.processdiscovery.minerwrapper.DecomposedMinerWrapper;
...
//	public MutableFuzzyGraph mineSP(final UIPluginContext context, XLog log) {
	public Object[] mine(final UIPluginContext context, XLog log) {
		...
		try {
			MiningResult mresult = miner.mineBestModel(log, baseMiner, ModelMetrics.FSCORE);
